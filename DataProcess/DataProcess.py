...
class DataProcess(object):
    ...
    def _lonLat(self, lon, lat, indicator, initIndex):
        ...
        self.logger.debug('Outputting data into ', init_lon_lat)
        self.logger.debug('Outputting data into ', origin_lon_lat)
        self.logger.debug('Outputting data into ', all_lon_lat)
        ...
        if self.ncflag:
            ...
            self.logger.debug('Outputting data into ', cyclone_tracks)
    ...
    def _bearing(self, bear, indicator, initIndex):
        ...
        if self.ncflag:
            ...
            self.logger.debug('Outputting data into ', all_bearing)
            ...
            self.logger.debug('Outputting data into ', init_bearing)
            ...
            self.logger.debug('Outputting data into ', bearing_no_init)
    ...
    def _pressure(self, pressure, indicator):
        ...
        if self.ncflag:
            ...
            self.logger.debug('Outputting data into ', pressure_no_init)
    ...
    def _pressureRate(self, pressure, dt, indicator):
        ...
        if self.ncflag:
            ...
            self.logger.debug('Outputting data into ', pressure_rate)
    ...
    def _bearingRate(self, bear, dt, indicator):
        ...
        if self.ncflag:
            ...
            self.logger.debug('Outputting data into ', bearing_rate)
    ...
    def _speedRate(self, dist, dt, indicator):
        ...
        if self.ncflag:
            ...
            self.logger.debug('Outputting data into ', speed_rate)
    ...
    def _windSpeed(self, windSpeed):
        ...
        if self.ncflag:
            ...
            self.logger.debug('Outputting data into ', wind_speed)
    ...
    def _rmaxRate(self, rmax, dt, indicator):
        ...
        self.logger.debug('Outputting data into ',
